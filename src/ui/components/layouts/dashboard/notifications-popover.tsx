...
import { fToNow } from '$logic/utils/format-time';
import { Scrollbar } from '$ui/components/shared/scrollbar';
import { DoneAll, NotificationsNoneOutlined } from '@mui/icons-material';
...
export type DashboardLayoutNotificationsPopoverProps = {};

export const DashboardLayoutNotificationsPopover: React.FC<
  DashboardLayoutNotificationsPopoverProps
> = () => {
...
const renderContent = (notification: NotificationModel) => {
  const title = (
